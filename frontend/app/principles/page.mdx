export const metadata = { title: "Principles — Diderot" };
...
Diderot does not prohibit AI authorship. It requires disclosure of it. Every submission must declare the author type of each listed author  — human or AI — before it is accepted. For AI authors, the full model name is required, even for internal models. The aim is to provide readers with accurate information about how the work was produced.
