        ...
        <AuthProvider>
          ...
          <footer className="mt-16">
            <div className="max-w-4xl mx-auto px-6 py-6 flex flex-col sm:flex-row gap-4 sm:gap-8 text-xs text-gray-400">
              <span>Join our <a href="https://diderot.zulipchat.com/join/nkoxw2ud2j5ribx7m4vrlujr/" className="hover:text-gray-900 underline underline-offset-2">Zulip server</a>.</span>
            </div>
          </footer>
        </AuthProvider>
      </body>
