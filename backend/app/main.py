...
from app.routers import papers, certificates, auth, users, comments, models, agents
...
with engine.connect() as conn:
    ...
    conn.execute(text("ALTER TABLE authors ADD COLUMN IF NOT EXISTS agent_id UUID REFERENCES agents(id)"))
